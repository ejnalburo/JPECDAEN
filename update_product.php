...
include 'config.php';
	...
	$pr_id = $pr_brand = $pr_name = $pr_supplier =  $unit =  $qty =  $price =  $exp_date = "";
	$valid = true;
	...
	if($valid){
		...
		$sql = "UPDATE products SET pr_brand = '$pr_brand', pr_name = '$pr_name', pr_supplier = '$pr_supplier', unit = '$unit', qty = '$qty', price = '$price', exp_date = '$exp_date' WHERE pr_id = '$pr_id'";
