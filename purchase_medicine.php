...
include 'config.php';
	...
	if($valid){
		...
		$sql0 = "UPDATE medicines SET qty = qty-'$qty' WHERE med_id = '$pr_id'";
		
		$query0 = mysqli_query($conn, $sql0); 


		$sql = "INSERT INTO sales(`sales_id`, `transaction_id`, `med_id`, `brand`, `name`, `unit`, `qty`, `price`, `total`) VALUES(NULL, '0', '$pr_id', '$brand', '$name',  '$unit', '$qty', '$price', '$total')";
