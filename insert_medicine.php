...
include 'config.php';
	...
	$med_brand = $med_name = $med_supplier =  $unit =  $qty =  $price =  $exp_date = "";
	$valid = true;
	...
	if($valid){
		...
		$sql = "INSERT INTO medicines(`med_id`, `med_brand`, `med_name`, `med_supplier`, `unit`, `qty`, `price`, `exp_date`, `date`) VALUES(NULL, '$med_brand', '$med_name', '$med_supplier', '$unit', '$qty', '$price', '$exp_date', CURDATE())";
