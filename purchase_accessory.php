...
include 'config.php';
	...
	if($valid){
		...
		$sql0 = "UPDATE accessories SET qty = qty-'$qty' WHERE acc_id = '$pr_id'";
		
		$query0 = mysqli_query($conn, $sql0); 


		$sql = "INSERT INTO sales(`sales_id`, `transaction_id`, `acc_id`, `brand`, `name`, `qty`, `price`, `total`) VALUES(NULL, '0', '$pr_id', '$brand', '$name', '$qty', '$price', '$total')";
