...
include 'config.php';
	...
	$name = $phone = $email =  $address =  $app_date =  $app_time =  $app_details = "";
	$valid = true;
	...
	if($valid){
		...
		$sql = "INSERT INTO appointments(`app_id`, `name`, `phone`, `email`, `address`, `app_date`, `app_time`, `app_details`) VALUES(NULL, '$name', '$phone', '$email', '$address', '$app_date', '$app_time', '$app_details')";
