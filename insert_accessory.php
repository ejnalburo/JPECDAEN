...
include 'config.php';
	...
	$acc_brand = $acc_name = $acc_supplier =  $qty =  $price =  "";
	$valid = true;
	...
	if($valid){
		...
		$sql = "INSERT INTO accessories(`acc_id`, `acc_brand`, `acc_name`, `acc_supplier`, `qty`, `price`, `date`) VALUES(NULL, '$acc_brand', '$acc_name', '$acc_supplier', '$qty', '$price', CURDATE())";
